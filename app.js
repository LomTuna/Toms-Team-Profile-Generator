...
// this below is where I'm stuck. no time to resolve currently
...
// this is a function method that allows for the questions to be answers with their proper validations/returns
const questions = {
    Manager: [
        {
            type: "input",
    ...
    Intern: [
        {
            ...
            validate: (value) => {
                if (value) {
                    return true
                } else { return "Please enter name of the intern." }
            },
        },
        {
            type: "input",
            ...
            validate: (value) => {
                if (value) {
                    return true
                } else { return "Please enter intern's identification number." }
            },
        },
        {
            type: "input",
        ...
        },
        {
            ...
            validate: (value) => {
                if (value) {
                    return true
                } else { return "Please enter the school's name." }
            },
        },
        {
            type: "list",
